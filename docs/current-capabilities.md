...
| Accepted-outcome mapping and claim execution | partial | [`packages/runtime/src/worker-plan.ts`](../packages/runtime/src/worker-plan.ts), [`packages/runtime/src/verifier.ts`](../packages/runtime/src/verifier.ts), [`packages/runtime/src/server-workflows.test.ts`](../packages/runtime/src/server-workflows.test.ts) | The current source format has no explicit outcome-to-claim relation, so Gaia preserves empty mappings and records non-passing claim results. Explicit source-owned mapping, claim execution, and the successful proof-bound V2-to-V3 path belong to GAIA-145. |
