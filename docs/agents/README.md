...
For Gaia, use them to turn the software-factory vision into Ready vertical-slice
Issues, delivery-owner tasks, independent exact-head review, and evidence-rich
PR decisions without bypassing the local-first artifact model.
