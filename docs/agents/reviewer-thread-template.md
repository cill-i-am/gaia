...
The reviewer must remain detached and strictly read-only. Route fixes to the
worker or a separately authorized implementation task; do not turn the reviewer
thread into an editing lane.
