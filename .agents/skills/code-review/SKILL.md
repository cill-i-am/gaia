---
name: code-review
description: Standards-backed code review. Use when reviewing a diff, PR, branch, staged or unstaged work, or before merge; report only proven behavioral, safety, boundary, architecture, runtime, or test-integrity issues.
---
...
Group findings in this order: `pre-edit blocker`, `pre-merge blocker`,
