...
const app_exe_name = "gaia-native-shell";
...
pub fn build(b: *std.Build) void {
    ...
    const frontend_build = b.addSystemCommand(&.{ "pnpm", "--filter", "@gaia/dashboard", "build" });
    const frontend_step = b.step("dashboard-build", "Build the dashboard frontend");
    ...
    const dev_step = b.step("dev", "Run the dashboard dev server and native shell");
