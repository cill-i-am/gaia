...
import {
  ...
  ThreadListParamsSchema, ThreadListResultSchema,
  ...
  type InitializeParams, type ThreadStartParams, type ThreadResumeParams, type ThreadReadParams, type ThreadListParams,
...
export function makeCodexAppServerClient(connection: CodexAppServerConnection) {
  ...
  return {
    ...
    listThreads: (params: ThreadListParams) => request("thread/list", params, ThreadListParamsSchema, ThreadListResultSchema),
